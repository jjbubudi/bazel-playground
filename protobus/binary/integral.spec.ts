import { decodeUint32, decodeBoolean, encodeUint32 } from './integral';
  ...
  describe('Uint32', () => {
    it('should decode varint into Uint32 and return its corresponding length', () => {
      [
        ...
        expect(decodeUint32(1, 0, new Uint8Array(bytes))).toEqual([value, bytes.length]);
      });
    });
  ...
  describe('Boolean', () => {
    it('should decode varint into Boolean and return its corresponding length', () => {
      [
        ...
        expect(decodeBoolean(1, 0, new Uint8Array(bytes))).toEqual([value, 1]);
      });
    });
